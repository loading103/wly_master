 ...
 * @Time        2020/5/6 9:12
 */
class VenueSelectResevationFragment : BaseFragment<FragVenueSelectReservationBinding, VenueReseravtionTimeViewModel>() {
...
//    var selectMap: HashMap<Int, Int> = hashMapOf()
    ...
    companion object {
        ...
        const val TYPE = "type"
        fun newInstance(venueId: String, type: Int): VenueSelectResevationFragment {

            var bundle: Bundle = Bundle()
            var frag = VenueSelectResevationFragment()
    ...
    override fun injectVm(): Class<VenueReseravtionTimeViewModel> {
        return VenueReseravtionTimeViewModel::class.java
    }
