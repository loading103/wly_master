...
internal object BaseHttpUrlConnectionHelper {
    ...
    private fun onExecute(wrap: RequestWrapper) {
        ...
        val isMultipart = !wrap.imgs.isNullOrEmpty() || !wrap.files.isNullOrEmpty()

        val isPostJson = !wrap.jsonParam.isNullOrEmpty()
...
//                writer.close()
    ...
    private fun downloadFile(wrap: RequestWrapper) {
        ...
        if (!wrap.downloadFileName.isNullOrEmpty()) {
