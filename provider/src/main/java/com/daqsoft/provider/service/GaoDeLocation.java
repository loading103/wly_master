...
public class GaoDeLocation {
    ...
    private OnGetCurrentLocationLisner1 lisner1 = null;
    static volatile GaoDeLocation defaultInstance;
...
//    }
    ...
    public static GaoDeLocation getInstance() {
        if (defaultInstance == null) {
            synchronized (GaoDeLocation.class) {
                if (defaultInstance == null) {
                    defaultInstance = new GaoDeLocation();
                }
            }
        }
    ...
    public interface OnGetCurrentLocationLisner {
        void onResult(String adCode, String result, double lat, double lon, String adcode);

        void onError(String errorMsg);
    }

    public interface OnGetCurrentLocationLisner1 {
        void onResult(String region, String address, double lat, double lon, String city);
    ...
    public void init(Context context, OnGetCurrentLocationLisner lisner, OnGetCurrentLocationLisner1 lisner1) {
        this.lisner = lisner;
        this.lisner1 = lisner1;
        // 初始化定位
        mLocationClient = new AMapLocationClient(context);
        // 设置定位回调监听
        mLocationClient.setLocationListener(mLocationListener);
        ...
        public void onLocationChanged(AMapLocation amapLocation) {
            if (amapLocation != null) {
                if (amapLocation.getErrorCode() == 0) {
                    ...
                    if (lisner1 != null) {
                        lisner1.onResult(amapLocation.getAdCode(), amapLocation.getAddress(),
                    ...
                    if (lisner != null) {
                        ...
                        lisner.onResult(amapLocation.getAdCode(), amapLocation.getAddress(),
                                amapLocation.getLatitude(), amapLocation.getLongitude(),
                                amapLocation.getAdCode());
                    }
                } else {
