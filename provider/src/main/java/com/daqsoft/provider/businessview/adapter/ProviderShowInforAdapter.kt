...
import com.daqsoft.provider.databinding.ItemShowInforListBinding
 ...
 * @Description 适配器
 */
class ProviderShowInforAdapter(private val context: Context): RecyclerViewAdapter<ItemShowInforListBinding, CultureListBean>(R.layout.item_show_infor_list) {

    @SuppressLint("CheckResult")
    override fun setVariable(mBinding: ItemShowInforListBinding, position: Int, item: CultureListBean) {
