...
internal class MultChooseResultAdapter(val totleNumber:String) : RecyclerViewAdapter<ItemSingleResultTextBinding, ChooseListBean>(R.layout.item_single_result_text) {
