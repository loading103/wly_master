 ...
 */
class ProviderAddCommentFragment :
    DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(resouceId: String, resouceType: String): ProviderAddCommentFragment {
            var frag = ProviderAddCommentFragment()
            var bundle: Bundle = Bundle()
            bundle.putString(RESOURCE_ID, resouceId)
