...
internal class SingleChooseAdapter() : RecyclerViewAdapter<ItemSingleTextBinding, ChooseListBean>(R.layout.item_single_text) {
    ...
    override fun setVariable(mBinding: ItemSingleTextBinding, position: Int, item: ChooseListBean) {
        ...
        mBinding.llRoot.onNoDoubleClick {
            ...
            getData().forEachIndexed { index, chooseListBean ->
                chooseListBean.haveChoosed=position==index
            }
