 ...
 * @Time        2020/4/1 16:45
 */
class ProviderCultureSpeakAdapter : RecyclerViewAdapter<ItemProviderSpeakingBinding, AudioInfo> {
...
//                mBinding.txtProviderCommentaryTotalTime.text=""+item.time
...
//            }
    ...
    override fun payloadUpdateUi(mBinding: ItemProviderSpeakingBinding, position: Int, payloads: MutableList<Any>) {
        ...
        mBinding.root.setBackgroundResource(R.drawable.shape_provider_fff_5)
        when (payloads[0]) {
            "updatePlayStatus" -> {
                // 更改所有Item播放状态
