...
import com.daqsoft.provider.databinding.LayoutProviderCommentsBinding
 ...
 * @Time        2020/4/2 15:15
 */
class ProviderCommentsView : FrameLayout {

    var mContext: Context? = null

    var binding: LayoutProviderCommentsBinding? = null
    ...
    private fun initView() {
        binding = DataBindingUtil.inflate(
            ...
            R.layout.layout_provider_comments,
            this,
            false
        )
...
//            binding?.tvProviderDetailsCommentCount?.text = mContext?.getString(R.string.provider_comment_num, num.toString())
    ...
    fun updateUi() {
//        var adapater = ProviderCommentAdapter(mContext!!,false)
        var adapater = ProviderCommentNewAdapter(mContext!!,false,type ="" )
        adapater?.emptyViewShow = false
        binding?.recyclerProviderDetailsComment?.layoutManager = LinearLayoutManager(
