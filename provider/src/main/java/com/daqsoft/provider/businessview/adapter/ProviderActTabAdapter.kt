 ...
 * @Time        2020/6/9 14:46
 */
class ProviderActTabAdapter : RecyclerViewAdapter<ItemProviderRecommendTabBinding, Classify> {
    ...
    override fun setVariable(mBinding: ItemProviderRecommendTabBinding, position: Int, item: Classify) {
        mBinding.name = item.labelName
