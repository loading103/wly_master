 ...
 * @describe 四川热门活动样式 1
 */
class SCPopularActivitiesStyleAdapterThree : SCPopularActivitiesStyleBaseAdapter<SCPopularActivitiesStyleAdapterThree.RecyclerViewItemHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewItemHolder {
        val mBinding = DataBindingUtil.inflate<ItemHomePopularActivityScStyleThreeBinding>(
            ...
            R.layout.item_home_popular_activity_sc_style_three,
            parent,
            false
        )
...
//                    activityRunName += "·还剩" + activityBean.stock + "个名额"
        ...
        val view = LayoutInflater.from(mBinding.root.context).inflate(
            R.layout.home_popular_activity_flowlayout_item_style_three,
            mBinding.flActivityLabel,
            false
        )
        view.findViewById<TextView>(R.id.label).text = activityRunName
        mBinding.flActivityLabel.addView(view)
