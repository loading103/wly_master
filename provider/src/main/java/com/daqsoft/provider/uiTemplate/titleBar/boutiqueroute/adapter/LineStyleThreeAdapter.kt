...
import com.daqsoft.provider.databinding.ItemBoutiqueRouteStyleThreeContentBinding
import com.daqsoft.thetravelcloudwithculture.home.bean.HomeContentBean

/**
 * 精品路线内容适配器样式三
 */
class LineStyleThreeAdapter :
    RecyclerViewAdapter<ItemBoutiqueRouteStyleThreeContentBinding, HomeContentBean>(R.layout.item_boutique_route_style_three_content) {
    override fun setVariable(mBinding: ItemBoutiqueRouteStyleThreeContentBinding, position: Int, item: HomeContentBean) {
