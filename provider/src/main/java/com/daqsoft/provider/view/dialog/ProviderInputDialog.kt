...
import kotlinx.android.synthetic.main.layout_provider_input_dialog.*
import kotlinx.android.synthetic.main.layout_provider_tip_dialog.*
import kotlinx.android.synthetic.main.layout_provider_tip_dialog.tv_cancel
import kotlinx.android.synthetic.main.layout_provider_tip_dialog.tv_confirm
 ...
 */
class ProviderInputDialog : Dialog {
    ...
    constructor(context: Context?, builder: Builder) : super(context, R.style.PrivacyStatementDialog) {
        setContentView(R.layout.layout_provider_input_dialog)
        if (builder != null) {
    ...
    private fun initViewEvent() {
        ...
        tv_confirm?.onNoDoubleClick {
            onTipConfirmListener?.onConfirm(et_content.text.toString(),this)
        }
    }
    ...
    class Builder {
         ...
         * 设置提示确认弹窗事件
         */
        fun setOnTipConfirmListener(onTipConfirmListener: ProviderInputDialog.OnTipConfirmListener): Builder {
        ...
        fun create(context: Context): ProviderInputDialog {
            return ProviderInputDialog(context, this)
        }
    }

    interface OnTipConfirmListener {
        fun onConfirm(content: String, providerInputDialog: ProviderInputDialog)
    }
