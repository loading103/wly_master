...
//                    System.out.println("12");
            ...
            mDarkView.setBackgroundColor(Color.parseColor("#51000000"));
    ...
    private void invokeBgCover(View view) {
        ...
        if (mDarkView != null) {
            ...
            mDarkView.setOnTouchListener(new View.OnTouchListener() {
                @Override
     ...
     * @param view
     */
    public void darkLeftOf(View view) {
