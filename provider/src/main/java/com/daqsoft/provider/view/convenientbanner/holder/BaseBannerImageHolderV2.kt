 ...
 */
class BaseBannerImageHolderV2 : Holder<String> {
    ...
    override fun updateUI(data: String?) {
        if (!data.isNullOrEmpty()) {
            if (imageView != null && imageView!!.context != null) {
                Glide.with(imageView!!.context).load(StringUtil.getImageUrlWatermark(data)).placeholder(R.drawable.placeholder_img_fail_240_180)
                    .into(imageView!!)
            }
        }
