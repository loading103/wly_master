 ...
 * @Version 1.0
 */
public class PlayChoosePopupWindow<T> extends BasePopupWindow {
    ...
    public static <T> PlayChoosePopupWindow getInstance(View view, List<T> datas, WindowDataBack windowDataBack) {
        LayoutInflater inflater = LayoutInflater.from(BaseApplication.context);
        View listContent = inflater.inflate(R.layout.layout_play_choose, null, false);
        PlayChoosePopupWindow listPopupWindow = new PlayChoosePopupWindow(listContent, LinearLayout.LayoutParams.MATCH_PARENT,
    ...
    public static <T> PlayChoosePopupWindow getInstance(View view, List<T> datas, int height, WindowDataBack windowDataBack) {
        LayoutInflater inflater = LayoutInflater.from(BaseApplication.context);
        View listContent = inflater.inflate(R.layout.layout_play_choose, null, false);
        PlayChoosePopupWindow listPopupWindow = new PlayChoosePopupWindow(listContent, LinearLayout.LayoutParams.MATCH_PARENT,
                height, datas, true);
    ...
    public static <T> PlayChoosePopupWindow getInstance(RecyclerView.LayoutManager manager, View view, List<T> datas, WindowDataBack windowDataBack) {
        LayoutInflater inflater = LayoutInflater.from(BaseApplication.context);
        View listContent = inflater.inflate(R.layout.layout_play_choose, null, false);
        PlayChoosePopupWindow listPopupWindow = new PlayChoosePopupWindow(listContent, LinearLayout.LayoutParams.MATCH_PARENT,
                LinearLayout.LayoutParams.WRAP_CONTENT, datas, true);
    ...
    private PlayChoosePopupWindow(View contentView, int width, int height, List<T> datas, boolean focusable) {
