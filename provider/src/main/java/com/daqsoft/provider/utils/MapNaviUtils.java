...
/**
 * @Description 跳转系统导航工具
 * @ClassName MapNaviUtils
 * @Author PuHua
 * @Time 2020/2/29 15:56
 * @Version 1.0
 */
...
//            }
     ...
     * 使用高德地图导航功能
     * @param context
     * @param startLatLng 起点纬度
     * @param endLatLng 起点经度
     * @param sname 起点名称
     * @param ename 终点名称
     */
    public static void openGaoDeNavi(Context context,LatLng startLatLng, LatLng endLatLng, String sname, String ename){
        ...
        Poi startPoi = new Poi(sname, startLatLng, "");
        Poi endPoi = new Poi(ename, endLatLng, "");
        AmapNaviPage.getInstance().showRouteActivity(
                context,
                new AmapNaviParams(startPoi, null, endPoi, AmapNaviType.DRIVER, AmapPageType.NAVI), null
        );
    }
