 ...
 */
public class MultiFileSelectorActivity extends FragmentActivity implements MultiFileSelectorFragment.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putInt(MultiFileSelectorFragment.EXTRA_SELECT_COUNT, mDefaultCount);
        bundle.putInt(MultiFileSelectorFragment.EXTRA_SELECT_MODE, mode);
        bundle.putBoolean(MultiFileSelectorFragment.EXTRA_SHOW_CAMERA, isShow);
        bundle.putParcelableArrayList(MultiFileSelectorFragment.EXTRA_DEFAULT_SELECTED_LIST, resultList);

        getSupportFragmentManager().beginTransaction()
                .add(R.id.image_grid, Fragment.instantiate(this, MultiFileSelectorFragment.class.getName(), bundle))
                .commit();
