 ...
 */
public class ItemCustomTouchHelper extends RecyclerView.ItemDecoration
     ...
     */
    public ItemCustomTouchHelper(@NonNull Callback callback) {
        mCallback = callback;
    }
    ...
    void select(@Nullable ViewHolder selected, int actionState) {
        if ((selected == mSelected && actionState == mActionState) || !mCallback.isCanDrag(selected)) {
            return;
        }
    ...
    public void startDrag(@NonNull ViewHolder viewHolder) {
        if (!mCallback.hasDragFlag(mRecyclerView, viewHolder) || !mCallback.isCanDrag(viewHolder)) {
    ...
    public abstract static class Callback {
        ...
        public abstract boolean isCanDrag(ViewHolder holder);
