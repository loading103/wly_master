...
public class FlexBoxLayout extends ViewGroup {
    ...
    public FlexBoxLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.FlexBoxLayout);
        horizontalSpace = ta.getDimension(R.styleable.FlexBoxLayout_horizontalSpace, 0);
        verticalSpace = ta.getDimension(R.styleable.FlexBoxLayout_vertivalSpace, 0);
        ta.recycle();
    }
    @Override
