...
public class CommBannerLayout extends RelativeLayout {
    ...
    private int selectedIndicatorColor = 0xffe5e5e5;
    private int unSelectedIndicatorColor = 0xffe5e5e5;
    ...
    private int cRadiu=15;
    private int indicatorSpace = 1;
    private int indicatorMarginh = 1;
    private int indicatorMarginv = 1;
    private int currentPosition;

    private ImageLoaderd imageLoader;
    private enum Shape {
        rect, oval
    }
    ...
    public CommBannerLayout(Context context) {
        this(context, null);
    }

    public CommBannerLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CommBannerLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        indicatorMarginh = (int) array.getDimension(R.styleable.BannerLayoutStyle_indicatorMarginh, indicatorMarginh);
        indicatorMarginv = (int) array.getDimension(R.styleable.BannerLayoutStyle_indicatorMarginv, indicatorMarginv);
        ...
        cRadiu=(int) array.getDimension(R.styleable.BannerLayoutStyle_selectedIndicatorCRadius, cRadiu);
        array.recycle();
        ...
        selectedGradientDrawable.setCornerRadius(cRadiu);
    ...
    public void setImageLoader(ImageLoaderd imageLoader) {
    ...
    public void setViews(final List<View> views) {
        ...
        //设置margin
        params.setMargins(indicatorMarginh, indicatorMarginv, indicatorMarginh, indicatorMarginv);
        ...
        indicator.setBackground(selectedDrawable);
        indicator.setText("1/"+itemCount);
    ...
    private void switchIndicator(int currentPosition) {
        String cup=""+(currentPosition+1)+"/"+itemCount;
        ((TextView) indicatorContainer.getChildAt(0)).setText(cup);
    }
    ...
    public interface ImageLoaderd extends Serializable {
