...
public class DatePopupWindow extends PopupWindow {
    ...
    private int selectColor = R.color.color_36cd64;
    private int startColor = R.color.color_36cd64;
    private int confirmDrawable = R.drawable.img_btn_bg_y;
    ...
    private DatePopupWindow(Builder builder) {
        ...
        this.confirmDrawable = builder.confirmDrawable;
...
//        backgroundAlpha(activity, 0.5f);
    ...
    private void initView() {
        ...
        tvOk.setBackground(activity.getDrawable(confirmDrawable));
            ...
            public void onClick(View v) {
                if (mOnClickListener != null) {
                    ...
                    String endDate = mList.get(endGroupPosition)
                            ...
                            .getDate();
                    String dayOffSet = CalendarUtil.getTwoDay(endDate, startDate);
                    mOnClickListener.getDate(startDate, endDate, startGroupPosition, startChildPosition, endGroupPosition, endChildPosition, dayOffSet);
                }
    ...
    private void create(View view) {
        this.showAtLocation(view, Gravity.BOTTOM | Gravity.BOTTOM, WindowManager.LayoutParams.MATCH_PARENT,
                0);
    }
    ...
    public interface DateOnClickListener {
        void getDate(String startDate, String endDate, int startGroupPosition, int startChildPosition, int endGroupPosition, int endChildPosition, String dayoffset);
    }
    ...
    public static class Builder {
        ...
        @SuppressLint("SimpleDateFormat")
        public Builder(Context context, Date date, View parentView) {
        ...
        public Builder setConfrimDrawable(int drawable) {
            this.confirmDrawable = drawable;
            return this;
        }

        public Builder setColor(int selectColor, int startColor) {
    ...
    private class DateAdapter extends BaseQuickAdapter<DateInfo, BaseViewHolder> {
        ...
        DateAdapter(List<DateInfo> data) {
        ...
        protected void convert(BaseViewHolder helper, DayInfo item) {
            ...
            if (status == 0) {
                if (isSelect) {
                    ...
                    (helper.getView(R.id.ll_bg)).setBackgroundColor(activity.getResources().getColor(selectColor));
                } else {
                    //没选中状态
                    helper.getView(R.id.tv_date).setVisibility(View.VISIBLE);
                    helper.getView(R.id.tv_status).setVisibility(View.GONE);
                ...
                ((TextView) helper.getView(R.id.tv_date)).setTextColor(activity.getResources().getColor(R.color.white));
                (helper.getView(R.id.ll_bg)).setBackgroundColor(activity.getResources().getColor(startColor));
            } else if (status == 2) {
                //结束
                helper.getView(R.id.tv_date).setVisibility(View.VISIBLE);
