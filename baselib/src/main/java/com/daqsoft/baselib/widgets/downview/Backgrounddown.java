...
public class Backgrounddown  extends Basedown {
        ...
        private void initTimeBgRect(float topPaddingSize) {
            ...
            if (isShowHour) {
                ...
                if (isShowTimeBgBorder) {
                    ...
                    int rights=Utils.dp2px(mContext,1);
                    mHourBgRectF = new RectF(mHourLeft, topPaddingSize, mHourLeft + mTimeBgSize+rights, topPaddingSize + mTimeBgSize);
                }
                // minute left point
        ...
        public int getAllContentWidth() {
            float width = getAllContentWidthBase(mTimeBgSize + (mTimeBgBorderSize * 2),mTimeBgBorderSize * 8);
