...
//        if (!isShowMinute && !isShowSecond) isShowSecond = true;
    ...
    private float getSuffixTextBaseLine(String suffixText) {
        ...
        switch (mSuffixGravity) {
            ...
            case 2:
                // bottom
                ret = mTimeTextBaseline - tempRect.bottom/2;
                break;
        }
    ...
    protected final float getAllContentWidthBase(float timeWidth,float w) {
    ...
    public int getAllContentWidth() {
        float width = getAllContentWidthBase(mTimeTextWidth,0);
