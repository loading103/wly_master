...
public class ExpandableTextView extends AppCompatTextView {
    ...
    private void initialize(Context context) {
        ...
        initWidth = dm.widthPixels - dp2px(context, 20f);

        mOpenSuffixColor = mCloseSuffixColor = Color.parseColor("#F23030");
        setMovementMethod(new OverLinkMovementMethod());
...
//                    }
    ...
    private void open() {
        if (hasAnimation) {
            ...
            mOpenHeight = layout.getHeight() + getPaddingTop() + getPaddingBottom()+dp2px(getContext(),20f);
            executeOpenAnim();
        } else {
        ...
        if (mOpenAnim == null) {
            ...
            mOpenAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    getLayoutParams().height = mOpenHeight +dp2px(getContext(),10);

                    View view = ((ConstraintLayout)getParent()).getChildAt(1);
        ...
        if (mCloseAnim == null) {
            ...
            mCloseAnim.setAnimationListener(new Animation.AnimationListener() {
                ...
                public void onAnimationEnd(Animation animation) {
                    ...
                    ExpandableTextView.super.setMaxLines(mMaxLines);
                    View view = ((ConstraintLayout)getParent()).getChildAt(1);
                    view.getLayoutParams().height -= mOpenHeight;
                    view.requestLayout();
                    setText(mCloseSpannableStr);
