package com.daqsoft.baselib.widgets.downview;
...
public class DownView extends View {
    private Basedown mCountdown;
    private CustomDownTimer mCustomCountDownTimer;
    ...
    public DownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCountdown = isHideTimeBackground ? new Basedown() : new Backgrounddown();
    ...
    public void start(long millisecond) {
        ...
        mCustomCountDownTimer = new CustomDownTimer(millisecond, countDownInterval) {
            @Override
            ...
            public void onFinish() {
                ...
                if (null != mOnCountdownEndListener) {
                    mOnCountdownEndListener.onEnd(DownView.this);
                }
            }
        };
    ...
    public interface OnCountdownEndListener {
        void onEnd(DownView cv);
    }

    public interface OnCountdownIntervalListener {
        void onInterval(DownView cv, long remainTime);
    }
    ...
    public void dynamicShow(DynamicConfig dynamicConfig) {
        ...
        if (!isHideTimeBackground && null != backgroundInfo) {
            Backgrounddown backgroundCountdown = (Backgrounddown) mCountdown;
