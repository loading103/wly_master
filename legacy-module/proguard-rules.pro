...
-keep class com.daqsoft.legacyModule.bean.**{
*;
}
-keep class com.daqsoft.legacyModule.media.bean.**{
*;
}
-keep class com.daqsoft.legacyModule.home.bean.**{
*;
}
-keep class com.daqsoft.legacyModule.smriti.bean.**{
*;
}
# IjkPlayer
