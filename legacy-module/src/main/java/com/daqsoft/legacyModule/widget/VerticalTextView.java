...
public class VerticalTextView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        init();
        // Load attributes
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LegacyModuleVerticalTextView, defStyle, 0);

        text = a.getString(R.styleable.LegacyModuleVerticalTextView_legacy_module_text);
        textColor = a.getColor(R.styleable.LegacyModuleVerticalTextView_legacy_module_textColor, Color.BLACK);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        textSize = a.getDimensionPixelSize(R.styleable.LegacyModuleVerticalTextView_legacy_module_textSize, textSize);
        rowSpacing = a.getDimensionPixelSize(R.styleable.LegacyModuleVerticalTextView_legacy_module_rowSpacing, rowSpacing);
        columnSpacing = a.getDimensionPixelSize(R.styleable.LegacyModuleVerticalTextView_legacy_module_columnSpacing, columnSpacing);
        columnLength = a.getInteger(R.styleable.LegacyModuleVerticalTextView_legacy_module_columnLength, -1);
        maxColumns = a.getInteger(R.styleable.LegacyModuleVerticalTextView_legacy_module_maxColumns, -1);
        atMostHeight = a.getBoolean(R.styleable.LegacyModuleVerticalTextView_legacy_module_atMostHeight, true);
        isCharCenter = a.getBoolean(R.styleable.LegacyModuleVerticalTextView_legacy_module_isCharCenter, true);
        textStyle = a.getInt(R.styleable.LegacyModuleVerticalTextView_legacy_module_textStyle, textStyle);
        a.recycle();
