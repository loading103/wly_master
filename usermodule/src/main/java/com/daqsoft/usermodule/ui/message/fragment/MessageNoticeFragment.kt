 ...
 */
class MessageNoticeFragment: BaseFragment<FragMessageListBinding, MessageTypeListViewModel>() {
    ...
    override fun initData() {
        ...
        (activity as MessageListActivity).showLoadingDialog()
        mModel.getListData(classify,type)
    }

    private fun initViewModel() {
        mModel.datas?.observe(this, Observer {
            (activity as MessageListActivity).dissMissLoadingDialog()
