 ...
 *启动页
 **/
class SplashActivityNew : BaseActivity<ActivitySplashNewBinding,SplashVm>() {
...
//            if(homeImageAd==null && homeImageAd?.adInfo!!.isNotEmpty()){
    ...
    private fun toMainPage(adInfo: AdInfo) {
        var intent = Intent()
        intent.setClass(this@SplashActivityNew, MainActivity::class.java)
        var bundle = Bundle()
    ...
    private fun setSplashAdsView(adInfos: ArrayList<AdInfo>) {
        ...
        mBinding.cbrSplashAds?.setPages(object : CBViewHolderCreator {
            override fun createHolder(itemView: View?): Holder<*> {
                return SplashAdsHolder(itemView, this@SplashActivityNew)
            }
