...
import com.daqsoft.thetravelcloudwithculture.databinding.FragmentHomeXjBinding
 ...
 * @since JDK 1.8.0_191
 */
class XJHomeFragment : BaseFragment<FragmentHomeXjBinding, XJHomeFragmentVm>() {
    ...
    val homeBannerAndHappyFragment: XJHomeBannerAndHappyFragment by lazy {
        XJHomeBannerAndHappyFragment()
    }
    ...
    override fun getLayout(): Int = R.layout.fragment_home_xj
    ...
    override fun initView() {
        ...
        isHideAnother = false
        // 一下为替换三个fragment
        var tripBranchNextFragment = XJTripBranchNextFragment()
        val activityTopicStoryFragment = XJActivityTopicStoryFragment()
    ...
    override fun notifyData() {
        ...
        mModel.cityCards.observe(this, Observer {
            ...
            if (it.size > 0) {
                ...
                mBinding.tvCardName.text = cityCardBean.name
