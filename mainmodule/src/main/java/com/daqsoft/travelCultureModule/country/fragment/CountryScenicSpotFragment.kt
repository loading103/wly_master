 ...
 * 景观点fragment
 */
class CountryScenicSpotFragment  : BaseFragment<ItemScenicSpotPagerBinding, BaseViewModel>() {

    private var datas: MutableList<Spots> = mutableListOf()
    private var adapter: CountryScenicSpotAdapter? = null
    ...
    companion object {
        ...
        fun newInstance(data: MutableList<Spots>, name: String?, imageUrl: String?, tags: String?, scenicTags: ScenicTags?, scenicId: Int): CountryScenicSpotFragment {
            var frag = CountryScenicSpotFragment()
            var bundle = Bundle()
...
//    }
    ...
    override fun initView() {
        ...
        adapter = CountryScenicSpotAdapter()
