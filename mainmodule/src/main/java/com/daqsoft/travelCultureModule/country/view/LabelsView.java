...
//            }
     ...
     * @param resId
     */
    public void setLabelBackgroundResource(int resId,int textColor) {
        setLabelBackgroundDrawable(getResources().getDrawable(resId),textColor);
    }
     ...
     * @param color
     */
    public void setLabelBackgroundColor(int color,int textColor) {
        setLabelBackgroundDrawable(new ColorDrawable(color),textColor);
    }
     ...
     * @param drawable
     */
    public void setLabelBackgroundDrawable(Drawable drawable,int color) {
//        mLabelBg = drawable;
        int count = getChildCount();
        for (int i = 0; i < count; i++) {
            if (i==0){
