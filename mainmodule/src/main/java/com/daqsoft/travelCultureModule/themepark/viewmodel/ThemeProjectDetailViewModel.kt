 ...
 * @Description
 */
class ThemeProjectDetailViewModel : BaseViewModel() {

    /**
     * 餐厅详情
     */
    val foodDetailLiveData: MutableLiveData<ThemeProjectDetailBean> = MutableLiveData()
    /**
     * 刷新数据状态
     */
    var refreshFoodDetailLiveData:MutableLiveData<ThemeProjectDetailBean> =MutableLiveData()
    /**
     * 收藏状态变更
     */
...
//        MainRepository.service.getPlayGroundetail(id).excute(object : BaseObserver<ThemeProjectDetailBean>(mPresenter) {
//            override fun onSuccess(response: BaseResponse<ThemeProjectDetailBean>) {
//                foodDetailLiveData.postValue(response.data)
//            }
//
//            override fun onFailed(response: BaseResponse<ThemeProjectDetailBean>) {
