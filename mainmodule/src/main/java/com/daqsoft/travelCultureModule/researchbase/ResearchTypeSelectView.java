...
public class ResearchTypeSelectView extends LinearLayout {
    ...
    public void setModel(String regionId, ResearchListViewModel model, FragmentActivity activity) {
        this.model = model;
        if (regionId != null) {
    ...
    public ResearchTypeSelectView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ResearchTypeSelectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
