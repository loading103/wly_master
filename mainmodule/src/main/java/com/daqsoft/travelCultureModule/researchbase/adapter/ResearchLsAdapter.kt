...
class ResearchLsAdapter : RecyclerViewAdapter<ItemResearchListBinding, ResearchBean> {
    ...
    constructor(context: Context) : super(R.layout.item_research_list) {
        mContext = context
    }

    @SuppressLint("CheckResult")
    override fun setVariable(
        mBinding: ItemResearchListBinding,
        position: Int,
        item: ResearchBean
    ) {
        mBinding.item = item
...
//        )
    ...
    override fun payloadUpdateUi(mBinding: ItemResearchListBinding, position: Int, payloads: MutableList<Any>) {
