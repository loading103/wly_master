 ...
 */
class ExhibitionOnlineFragment: BaseFragment<FragExhibitionListBinding, ExhibitionLsViewModel>() {
    // List适配器
    private val mAdapter by lazy { ExhibitionOnLineAdapter() }
    ...
    private fun initEvent() {
        // 点击收藏
        mAdapter?.onCollectClickListener = object : ExhibitionOnLineAdapter.OnCollectClickListener {
