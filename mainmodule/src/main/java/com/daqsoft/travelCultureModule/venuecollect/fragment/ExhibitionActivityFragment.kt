...
import com.daqsoft.travelCultureModule.venuecollect.adapter.ActivityListAdapter
 ...
 */
class ExhibitionActivityFragment: BaseFragment<FragExhibitionListBinding, ExhibitionLsViewModel>() {
    // List适配器
    private val mAdapter by lazy { ActivityListAdapter().apply {
        emptyViewShow=false
    } }
    ...
    private fun initViewModel() {
        mModel.activities.observe(this, androidx.lifecycle.Observer {
    ...
    private fun initEvent() {
        // 点击收藏
        mAdapter?.onCollectClickListener = object : ActivityListAdapter.OnCollectClickListener {
