...
/**
 * @Description 两级选择pop
 * @ClassName SecondSelectPopupWindow
 * @Author luoyi
 * @Time 2020/2/24 17:26
 * @Version 1.0
 */
public class SecondSelectPopupWindow extends BasePopupWindow {
    ...
    public static SecondSelectPopupWindow getInstance(Context context, Boolean multiSelect,
                                                      WindowDataBack back) {
        return new SecondSelectPopupWindow(back, multiSelect,
                (LayoutLabelSelectBinding) DataBindingUtil.inflate(
                        LayoutInflater.from(context),
                        R.layout.layout_label_select,
                        null,
                        false
                ));
    }
    ...
    private SecondSelectPopupWindow(WindowDataBack back, Boolean multiSelect,
                                    LayoutLabelSelectBinding binding) {
