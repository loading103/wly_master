...
public class ResourceTypeSelectView extends LinearLayout {
    ...
    public void setModel(String regionId, ScenicListViewModel model, FragmentActivity activity) {
        this.model = model;
        if (regionId != null) {
    ...
    public ResourceTypeSelectView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ResourceTypeSelectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void init(final Context context) {
        ...
        sorts.add(new ValueKeyBean("可订优先","isOpen",false));
