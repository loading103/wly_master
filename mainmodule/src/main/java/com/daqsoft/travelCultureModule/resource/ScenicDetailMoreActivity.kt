 ...
 */
@Route(path = MainARouterPath.MAIN_SCENIC_DETAIL_MORE)
class ScenicDetailMoreActivity :
    TitleBarActivity<MainSecnicDetailActivityMoreBinding, ScenicDetailViewModel>() {
    ...
    override fun getLayout(): Int = R.layout.main_secnic_detail_activity_more
    ...
    private var mScenicBean: ScenicDetailBean? = null
        ...
        if (mScenicBean != null && !mScenicBean!!.officialUrl.isNullOrEmpty()) {
            if (mQrCodeDialog == null) {
                mQrCodeDialog = QrCodeDialog.Builder().qrCodeImageUrl(mScenicBean!!.officialUrl)
                    ...
                    .build(this@ScenicDetailMoreActivity)
            } else {
