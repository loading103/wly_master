...
class ContentActivityViewModel : BaseViewModel() {
    ...
    fun getZixunList(
        ...
        pageSize: String, currPage: String, region: String, areaSiteSwitch: String
    ) {
        mPresenter.value?.loading = false
        MainRepository.service.getClubZixunList(
            linksResourceId, linksResourceType, orderType,
            pageSize, currPage, region, channelCode, areaSiteSwitch
