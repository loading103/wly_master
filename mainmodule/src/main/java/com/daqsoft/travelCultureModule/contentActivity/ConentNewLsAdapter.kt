...
import com.daqsoft.mainmodule.databinding.ItemContentLsNewBinding
 ...
 * @Time        2020/6/4 16:06
 */
class ConentNewLsAdapter : RecyclerViewAdapter<ItemContentLsNewBinding, ClubZixunBean> {

    var mContext: Context? = null

    constructor(context: Context) : super(R.layout.item_content_ls_new) {
        mContext = context
    }

    override fun setVariable(mBinding: ItemContentLsNewBinding, position: Int, item: ClubZixunBean) {
        if (item != null) {
