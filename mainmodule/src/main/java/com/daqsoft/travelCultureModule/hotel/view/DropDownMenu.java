...
import com.daqsoft.travelCultureModule.hotel.util.DeviceUtils;
...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        underLine.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 0));
    ...
    private void addTab(@NonNull List<String> tabTexts, int i) {
        ...
        tab.setCompoundDrawablePadding(dpTpPx(getResources().getDimension(R.dimen.dp_3)));
        tab.setPadding((int) getResources().getDimension(R.dimen.dp_20),
