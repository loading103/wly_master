...
/**
 * @Description 活动的适配器
 * @ClassName   HotActivityAdapter
 * @Author      luoyi
 * @Time        2020/03/18 17:48
 */
class HotActivityAdapter(context: Context, vm: HotActivitiesFragmentViewModel) :
    RecyclerViewAdapter<MainItemHotActivityBinding, ActivityBean>(
        R.layout.main_item_hot_activity
    ) {
    private val mContext: Context = context

    private val mViewModel: HotActivitiesFragmentViewModel = vm
