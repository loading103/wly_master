package com.daqsoft.travelCultureModule.playground.view;
...
public class PlayGroundSelectPopupWindow extends BasePopupWindow {
    ...
    public static PlayGroundSelectPopupWindow getInstance(Context context, Boolean multiSelect,
                                                          WindowDataBack back) {
        return new PlayGroundSelectPopupWindow(back, multiSelect,
    ...
    private PlayGroundSelectPopupWindow(WindowDataBack back, Boolean multiSelect,
                ...
                mBinding.tvItem.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (firstSelect == 0) {
                            ...
                            applyType = secondData.get(position).getId();
                        } else if (firstSelect == 2){
                            eqt = secondData.get(position).getId();
                        } else {
                            feature = secondData.get(position).getId();
                        }
...
//                        dismiss();
        ...
        RxView.clicks(mBinding.tvSure)
                ...
                .subscribe(new Consumer<Object>() {
                    ...
                    public void accept(Object o) throws Exception {
                        if (windowDataBack != null) {
                            windowDataBack.select(type, applyType,eqt,feature);
                        }
                        dismiss();
                    }
                });
    ...
    public interface WindowDataBack {
        void select(String type, String apply,String eqt, String feature);
