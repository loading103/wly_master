 ...
 */
class SideTourToilentPageAdapter : FragmentStatePagerAdapter {
    ...
    override fun getItem(position: Int): Fragment {
        return SideTourToilentFragment.newInstance(mDatas[position], position, mDatas.size, lat, lng,isService)
    }
