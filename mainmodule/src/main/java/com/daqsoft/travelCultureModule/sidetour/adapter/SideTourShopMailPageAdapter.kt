 ...
 */
class SideTourShopMailPageAdapter : FragmentStatePagerAdapter {
    ...
    override fun getItem(position: Int): Fragment {
        return SideTourShopMailFragment.newInstance(mDatas[position], position, mDatas.size, lat, lng,isService)
    }
