...
public abstract class JCVideoPlayer extends FrameLayout implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, View.OnTouchListener {
    ...
    /**
     * 是否播放直播链接，true  不显示 进度条 和 总时间
     */
    public boolean IS_PLAYING_LIVE_URL = false;
    ...
    public void setUiWitStateAndScreen(int state) {
        ...
        switch (currentState) {
            ...
            case CURRENT_STATE_PLAYING:
                if (onJcVideoPlayerListener != null) {
                    onJcVideoPlayerListener.onStartPlayer();
                }
            case CURRENT_STATE_PAUSE:
                if (onJcVideoPlayerListener != null) {
                    onJcVideoPlayerListener.onPause();
                }
            ...
            case CURRENT_STATE_ERROR:
                cancelProgressTimer();
                if (onJcVideoPlayerListener != null) {
                    onJcVideoPlayerListener.onError();
                }
                break;
            case CURRENT_STATE_AUTO_COMPLETE:
                ...
                if (onJcVideoPlayerListener != null) {
                    onJcVideoPlayerListener.onComplete();
                }
                break;
        }
    }
...
//        ((ViewGroup)JCMediaManager.textureView.getParent()).removeView(JCMediaManager.textureView);
        ...
        try {
            ...
            if (IS_PLAYING_LIVE_URL) {
                jcVideoPlayer.progressBar.setVisibility(View.INVISIBLE);
                jcVideoPlayer.totalTimeTextView.setVisibility(View.INVISIBLE);
            }
...
//            jcVideoPlayer.setAnimation(ra);
    ...
    OnJcVideoPlayerListener onJcVideoPlayerListener = null;

    public void setOnJcVideoPlayerListener(OnJcVideoPlayerListener listener) {
        this.onJcVideoPlayerListener = listener;
    }

    public interface OnJcVideoPlayerListener {
        /**
         * 开始播放
         */
        void onStartPlayer();
