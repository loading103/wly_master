 ...
 * On 2016/04/18 16:15
 */
public class JCVideoPlayerDqUI extends JCVideoPlayer {

    public interface StateChangeListener {
        public void isThumbIsVisible(boolean visible);
    }
    ...
    public ImageView startPlayImageView;
    protected DismissControlViewTimerTask mDismissControlViewTimerTask;


    public JCVideoPlayerDqUI(Context context) {
        super(context);
    }

    public JCVideoPlayerDqUI(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void init(Context context) {
        ...
        startPlayImageView = (ImageView) findViewById(R.id.start);
    ...
    public void setUiWitStateAndScreen(int state) {
        ...
        if (mStateChangeListener != null) {
            mStateChangeListener.isThumbIsVisible(thumbImageView.getVisibility() == View.VISIBLE);
        }
    }
